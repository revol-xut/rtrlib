...
#define VERIFY_AS_PATH(direction, result, ...) \
	assert(result == aspa_verify_as_path(aspa_table, ASNS(__VA_ARGS__), sizeof(ASNS(__VA_ARGS__))/sizeof(uint32_t), direction));
...
static void test_upstream(struct aspa_table* aspa_table) {
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_VALID, 100);

	// valid upstream paths
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_VALID, 200, 100);
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_VALID, 300, 200);
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_VALID, 300, 200, 100);

	// single not-provider hop (nP)

	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 999, 100);
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 300, 999, 100);
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 999, 999, 100);
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 999, 100, 999);

	// single unattested hop (nA)
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_UNKNOWN, 999, 500, 400, 300);
}

static void test_downstream(struct aspa_table* aspa_table) {
	// paths of length 1 <= N <= 2 are valid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 999);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 998, 999);

	// either up- or down-ramp is valid, not both
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 300, 400, 500);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 500, 400, 300);

	// w/o customer-provider gap
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 300, 400, 500, 400, 300);

	// single not-provider (nP) in between
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 302, 402, 502, 500, 400, 300);

	// two highest-level hops are nP
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 301, 401, 501, 502, 502, 402, 302);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 302, 402, 502, 999, 500, 400, 300);

	// single nA at highest level is valid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 999, 500, 400, 300);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 300, 400, 500, 999);

	// single nP at highest level is valid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 999, 502, 402, 302);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 302, 402, 502, 999);

	// the last hop in the down ramp must be valid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 999, 300, 400, 500);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 100, 300, 400, 500);

	// the first hop in the up ramp must be valid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 500, 400, 300, 999);
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 500, 400, 300, 100);

	// consecutive up-ramps are invalid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 400, 300, 200, 502, 402, 302);

	// consecutive down-ramps are invalid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 200, 300, 400, 302, 402, 502);

	// both down- and up-ramp are invalid
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 400, 300, 200, 302, 402, 502);

	// overlapping customer-provider-relationships
	// 103 --> 203 <--> 303 <--> 403 <-- 304
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 304, 403, 303, 203, 103);

	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 20, 30, 90, 40, 70, 80);
}
...
static void test_verify_example_1()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 20, 30, 40, 70, 80);
}
...
static void test_verify_example_2b()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 20, 30, 90, 40, 70, 80);
}
...
static void test_verify_example_3b()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 20, 30, 90, 100, 40, 70, 80);
}
...
static void test_verify_example_3c()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 20, 30, 90, 100, 40, 70, 80);
}
...
static void test_verify_example_3d()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 20, 30, 40, 100, 90, 70, 80);
}
...
static void test_verify_example_4()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 20, 30, 40, 50, 60, 70, 80);
}
...
static void test_verify_example_5()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_VALID, 20, 30, 40);
}
...
static void test_verify_example_6()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_INVALID, 20, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120);
}
...
static void test_verify_example_7()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_UNKNOWN, 20, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140);
}
...
static void test_verify_example_8()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 20);
}
...
static void test_verify_example_9()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_VALID, 20);
}
...
static void test_verify_example_11()
{
	...
	VERIFY_AS_PATH(ASPA_DOWNSTREAM, ASPA_AS_PATH_VALID, 20, 30);
}
...
static void test_verify_example_12()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_UNKNOWN, 20, 30);
}
...
static void test_verify_example_13()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 20, 30, 40, 50, 60);
}
...
static void test_verify_example_16()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 10, 20, 30, 40);
}
...
static void test_verify_example_18()
{
	...
	VERIFY_AS_PATH(ASPA_UPSTREAM, ASPA_AS_PATH_INVALID, 30, 20, 40);
}
